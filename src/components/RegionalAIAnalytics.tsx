...
import { Brain, TrendingUp, AlertTriangle, Lightbulb, Sprout, MapPin } from "lucide-react";
        ...
        <Card key={data.id} className="overflow-hidden border-l-4 border-l-primary">
          <CardHeader className="bg-gradient-to-r from-primary/5 to-accent/5">
            <CardTitle className="flex items-center gap-2">
              ...
              {data.crop ? t(`crops.${data.crop}`) : t("regionalAI.allCrops")}
            </CardTitle>
            {data.last_updated && (
          ...
          <CardContent className="pt-6 space-y-4">
            ...
            {/* Fertilizer Tip */}
            {data.fertilizer_tip && (
              <div className="p-4 rounded-lg bg-teal-50 dark:bg-teal-950/20 border border-teal-200 dark:border-teal-900">
                <div className="flex items-start gap-3">
